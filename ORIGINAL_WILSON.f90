...
!---------------------------input and initialisation---------------------------
   open (10,file='Data\R25M.dat',status=    'old',action='read')
   open (11,file='Results\R25M.res',status='replace',action='write')                   
